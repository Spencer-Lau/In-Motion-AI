...
import {
  ...
  getUniqueMuscles,
  getUniqueCategories,
} from '../controllers/exerciseController.js'; // imports exerciseController module (handles original id/name, muscle dropdown, and category dropdown SQL query generation, db req, and response)
